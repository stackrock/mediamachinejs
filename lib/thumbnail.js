...
exports.ThumbnailJob = void 0;
var api_1 = require("./api");
var utils_1 = require("./utils");
var watermark_1 = require("./watermark");
var job_1 = require("./job");
var ThumbnailJob = /** @class */ (function () {
    function ThumbnailJob() {
    }
    ThumbnailJob.withDefaults = function () {
        var tj = new ThumbnailJob();
        tj.thumbWidth = 720;
        return tj;
    };
    ThumbnailJob.prototype.apiKey = function (key) {
        this.apikey = key;
        return this;
    };
    ThumbnailJob.prototype.webhooks = function (webhooks) {
        this.successUrl = webhooks.successUrl;
        this.failureUrl = webhooks.failureUrl;
        return this;
    };
    ThumbnailJob.prototype.from = function (source) {
    ...
    ThumbnailJob.prototype.to = function (destination) {
    ...
    ThumbnailJob.prototype.watermark = function (watermark) {
        this.thumbWatermark = watermark;
        return this;
    };
    ThumbnailJob.prototype.watermarkFromText = function (text) {
        var watermark = watermark_1.Watermark.withDefaults().text(text);
        this.thumbWatermark = watermark;
        return this;
    };
    ThumbnailJob.prototype.width = function (width) {
        this.thumbWidth = width;
        return this;
    };
    ThumbnailJob.prototype.execute = function () {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        body = {
                            ...
                            watermark: (_a = this.thumbWatermark) === null || _a === void 0 ? void 0 : _a.toJSON(),
                            inputBlob: (_b = this.inputBlob) === null || _b === void 0 ? void 0 : _b.toJSON(),
                            outputBlob: (_c = this.outputBlob) === null || _c === void 0 ? void 0 : _c.toJSON(),
                        };
                        return [4 /*yield*/, api_1.API.createJob("thumbnail", utils_1.removeUndefinedFromObj(body))];
                    case 1:
                        resp = _d.sent();
...
exports.ThumbnailJob = ThumbnailJob;
