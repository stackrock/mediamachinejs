            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        body = __assign({ apiKey: this.apiKey, successURL: this.successUrl, failureURL: this.failureUrl, inputCreds: (_a = this.inputBlob) === null || _a === void 0 ? void 0 : _a.toApiCredentials(), outputCreds: (_b = this.outputBlob) === null || _b === void 0 ? void 0 : _b.toApiCredentials(), inputURL: this.inputUrl || this.inputBlob.toApiUrl(), outputURL: this.outputUrl || this.outputBlob.toApiUrl(), width: "" + this.transcodeWidth, height: !!this.transcodeHeight ? "" + this.transcodeHeight : undefined, watermark: (_c = this.transcodeWatermark) === null || _c === void 0 ? void 0 : _c.toJSON() }, (_d = this.transcodeOpts) === null || _d === void 0 ? void 0 : _d.toJSON());
