...
var FAKE_TRANSCODE_OPTS = new transcode_1.TranscodeOpts();
var FAKE_S3_BLOB = new blob_1.Blob({
    region: "us-east-1",
    accessKeyId: "123",
    secretAccessKey: "abc",
    type: blob_1.Store.S3,
}, "test-bucket", "test-key");
var FAKE_GCP_BLOB = new blob_1.Blob({
    type: blob_1.Store.GOOGLE_BLOB,
    json: "{}",
}, "test-bucket", "test-key");
var FAKE_AZURE_BLOB = new blob_1.Blob({
    type: blob_1.Store.AZURE_BLOB,
    accountKey: "123",
    accountName: "abc",
}, "test-bucket", "test-key");
var FAKE_IMAGE_WATERMARK = new watermark_1.ImageWatermark({
    height: 200,
    width: 400,
    url: "http://path.com/to/your/image",
});
var textWatermark = new watermark_1.TextWatermark("mediamachine.io");
describe("Mediamachine", function () {
    describe("thumbnail", function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        mock
                            ...
                            .reply(201, retData);
                        return [4 /*yield*/, expect(new thumbnail_1.ThumbnailJob("test-123")
                                .webhooks({
                                successUrl: FAKE_SUCCESS_URL,
                                failureUrl: FAKE_FAILURE_URL,
                            })
        ...
        test("with a null apikey throws an error", function () {
            expect(new thumbnail_1.ThumbnailJob("test-123")
                .webhooks({
                successUrl: FAKE_SUCCESS_URL,
                failureUrl: FAKE_FAILURE_URL,
            })
    ...
    describe("Gif Summary", function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        mock
                            ...
                            .reply(201, retData);
                        return [4 /*yield*/, expect(new summary_1.SummaryJob("test-123")
                                .webhooks({
                                successUrl: FAKE_SUCCESS_URL,
                                failureUrl: FAKE_FAILURE_URL,
                            })
        ...
        test("with empty string apikey throws an error", function () {
            expect(new summary_1.SummaryJob("")
                .webhooks({
                successUrl: FAKE_SUCCESS_URL,
                failureUrl: FAKE_FAILURE_URL,
            })
        ...
        test("with no input_url or input_blob provided throws an error", function () {
            expect(new summary_1.SummaryJob('test-123')
                .webhooks({
                successUrl: FAKE_SUCCESS_URL,
                failureUrl: FAKE_FAILURE_URL,
            })
    ...
    describe("Transcode", function () {
        ...
        test("with all required properties does not fail", function () {
            ...
            expect(new transcode_1.TranscodeJob("test-123")
                .webhooks({
                successUrl: FAKE_SUCCESS_URL,
                failureUrl: FAKE_FAILURE_URL,
            })
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        mock
                            ...
                            .reply(201, retData);
                        return [4 /*yield*/, expect(new transcode_1.TranscodeJob("test-123")
                                .webhooks({
                                successUrl: FAKE_SUCCESS_URL,
                                failureUrl: FAKE_FAILURE_URL,
                            })
        ...
        test("with empty string apikey throws an error", function () {
            expect(new transcode_1.TranscodeJob("")
                .webhooks({
                successUrl: FAKE_SUCCESS_URL,
                failureUrl: FAKE_FAILURE_URL,
            })
