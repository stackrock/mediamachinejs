                ...
                switch (_d.label) {
                    case 0:
                        ...
                        body = {
                            ...
                            outputCreds: (_b = this.inputBlob) === null || _b === void 0 ? void 0 : _b.toApiCredentials(),
                            successURL: this.successUrl,
                            failureURL: this.failureUrl,
                            inputURL: this.inputUrl || this.inputBlob.toApiUrl(),
                            outputURL: this.outputUrl || this.outputBlob.toApiUrl(),
                            width: "" + this.thumbWidth,
                            watermark: (_c = this.thumbWatermark) === null || _c === void 0 ? void 0 : _c.toJSON(),
                        };
